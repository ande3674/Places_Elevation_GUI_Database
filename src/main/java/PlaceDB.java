...
public class PlaceDB {
    //Connection string – where's the database?
    private static final String DB_CONNECTION_URL = "jdbc:sqlite:databases\\places.sqlite";
    ...
    String addRecord(Place place)  {
        ...
        try (Connection conn = DriverManager.getConnection(DB_CONNECTION_URL);
            ...
            // this way is for variables with data from the user
            // PreparedStatement objects are for USER DATA,
            // for queries, updates etc. , not creating tables.
            // You shouldn't make database schemas from user input
